...
dnsmasq, nftables, a Docker Hub pull-through cache, gitlab-runner. Guest image:
Ubuntu 24.04 with Docker CE (buildx, compose), git and gitlab-runner.
...
- Jobs reach the host only for DHCP, DNS and the image cache (IPv4 and IPv6 filtered).
